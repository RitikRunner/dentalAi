...
export const analysisSchema = z.object({
    ...
    was_converted: z.boolean().describe("True if the patient successfully booked an appointment by the end of the conversation. False if they did not book."),
    conversion_failure_reason: z.string().describe("If was_converted is false, explain why the CRM failed to convert the lead (e.g., 'Did not offer alternate times', 'Lacked enthusiasm', 'Patient needed to check schedule'). If true, leave empty."),
